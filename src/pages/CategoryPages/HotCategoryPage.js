...
import CategoryHotState from "../../components/Category/CategoryComponent";


function HotCatecoryPage() {

    const [unitTemp, setUnitTemp] = useState(CategoryHotState);
    ...
    return (
        ...
        
        {
            unitTemp.map((_, index)=>{
                return <CategoryUnitCom  index={index} stating={CategoryHotState}/>
            })
        }
...
export default HotCatecoryPage;